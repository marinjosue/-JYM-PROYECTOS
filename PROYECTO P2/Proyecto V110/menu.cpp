                    ...
                    case 4:
                      {
                       ...
                       system("cls");
                        ...
                        std::string cedulaIngresada = "0504345927";
                        std::string rutaArchivo = carpetaUsuarios + "/" + cedulaIngresada + ".txt";
                        // Llamar a la función obtenerSaldoActual pasando la ruta del archivo como argumento
                        double saldoActual = movimiento.obtenerSaldoActual(rutaArchivo);
                        std::cout << "El saldo actual es: $" << saldoActual << std::endl;
                        system("pause");
                        break;
                      }
                    case 5:
