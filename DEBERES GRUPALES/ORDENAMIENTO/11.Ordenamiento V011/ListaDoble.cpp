...
template <typename T>
void ListaDoble<T>::orden_seleccion(const std::string& criterio) {
    Nodo<T>* actual = cabeza;
    ...
    while (actual != nullptr) {
        ...
        while (temp != nullptr) {
            if (criterio == "Nombre" && temp->get_valor()->getNombre() < minimo->get_valor()->getNombre()) {
                minimo = temp;
            } else if (criterio == "Apellido" && temp->get_valor()->getApellido() < minimo->get_valor()->getApellido()) {
                minimo = temp;
            } else if (criterio == "Cedula" && temp->get_valor()->getCedula() < minimo->get_valor()->getCedula()) {
                minimo = temp;
            }
