 ...
 */
 ...
 std::string newCedula, newNombre, newApellido, newId;
  do {
    ...
    //newCedula =            ingresar_reales("cedula");
    // Validar que la cédula no exista previamente
    /*if (cedula.buscar(newCedula)) {
      cout << "La cédula ya existe. Ingrese otra cédula." << endl;
      return Persona();
    }*/
    ...
    if (validarCedula(newCedula)) {
      ...
      cout << "La cédula ingresada es inválida. Vuelva a intentarlo." << endl;
    }
  } while (true);
