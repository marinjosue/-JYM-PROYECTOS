...
#include "ListaDoble.h"  // Agrega la inclusión del archivo de encabezado de ListaDoble
#include "Persona.h"    // Agrega la inclusión del archivo de encabezado de Persona
